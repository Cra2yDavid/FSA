...
from networks import SelfAttentionNetWeighted_Factor_O, SelfAttentionNetWeighted_Factor_S, \
    SelfAttentionNetWeighted_Factor_E  # ablations
...
def train(args=get_args()):
    ...
    if args.method == 'PPO' or args.method == 'A2C':
        ...
        if args.method == 'duelingDQN' or args.method == 'FSA':
